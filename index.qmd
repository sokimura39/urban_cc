...
This website is created for the ARC6975 Trajectories in Spatial Practices as part of the MA Urban Design course at the University of Sheffield's School of Architecture and Landscape. 

Here I walk through the [*Urban Data & Design Game*](game.qmd) that I have created for the game, as well as [additional insights from the datasets](data.qmd) that could not be expressed through the deliverables.
